...
if args.mode == 'cz':
    df_succes.append(df_fail).to_csv(r'../Scrape/output/HornbachCZ_results.csv', index=False)
else:    
    df_succes.append(df_fail).to_csv(r'../Scrape/output/HornbachSK_results.csv', index=False)
